...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,t){var s=t(/*! ./_global */"./node_modules/core-js/modules/_global.js"),n=t(/*! ./_core */"./node_modules/core-js/modules/_core.js"),r=t(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),d=t(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),l=t(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),u=function(e,o,t){var c,i,a,m,p=e&u.F,j=e&u.G,f=e&u.S,y=e&u.P,_=e&u.B,v=j?s:f?s[o]||(s[o]={}):(s[o]||{}).prototype,b=j?n:n[o]||(n[o]={}),h=b.prototype||(b.prototype={});for(c in j&&(t=o),t)a=((i=!p&&v&&void 0!==v[c])?v:t)[c],m=_&&i?l(a,s):y&&"function"==typeof a?l(Function.call,a):a,v&&d(v,c,a,e&u.U),b[c]!=a&&r(b,c,m),y&&h[c]!=a&&(h[c]=a)};s.core=n,u.F=1,u.G=2,u.S=4,u.P=8,u.B=16,u.W=32,u.U=64,u.R=128,e.exports=u},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,t){"use strict";t.r(o);t(/*! core-js/modules/es6.regexp.replace */"./node_modules/core-js/modules/es6.regexp.replace.js");o.default=function(){let e={loading:"Загрузка...",success:"Спасибо! Скоро мы с вами свяжемся!",failure:"Что-то пошло не так"},o=document.querySelector(".popup-design form"),t=document.getElementById("design-name"),s=document.getElementById("design-phone"),n=document.getElementById("design-email"),r=document.querySelector(".popup-consultation form"),d=r.querySelector("#consultation-name"),l=r.querySelector("#consultation-phone"),u=document.getElementById("textarea"),c=document.createElement("div"),i=document.createElement("button"),a=document.querySelector(".popup-consultation .popup-content"),m=document.querySelector(".popup-consultation h4"),p=document.querySelector(".popup-consultation .main-form"),j=document.querySelector(".popup-design .popup-content"),f=document.querySelector(".popup-design h4"),y=document.querySelector(".popup-design .file_uploa"),_=document.querySelector(".popup-design .main-form"),v=document.querySelector(".consultation"),b=document.querySelector(".consultation .col-md-offset-1"),h=document.querySelector(".consultation form"),g=document.querySelector(".main-form input"),S=document.getElementById("consultation-phone"),L=document.getElementById("consult-email"),x=document.getElementById("consult-name"),k=document.getElementById("consult-phone"),E=document.getElementById("consult-text"),w=document.querySelector(".consultation form .input-text"),q=document.querySelector(".consultation .p-heading"),O=document.querySelector(".consultation h2"),T=document.querySelector(".popup-design .popup-close"),A=document.querySelector(".popup-consultation .popup-close"),P=document.querySelector(".popup-design"),$=document.querySelector(".popup-consultation");function C(t,s,n,d){t==r||t==o?s.appendChild(c):t==h&&(s.appendChild(i),s.insertBefore(c,i)),t.addEventListener("submit",function(l){l.preventDefault();let u=new FormData(t);t==r||t==o?s.appendChild(c):t==h&&(s.appendChild(c),s.appendChild(i)),function(e){return new Promise(function(o,t){let s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-type","application/json; charset=utf-8"),s.onreadystatechange=function(){s.readyState<4?o():4===s.readyState&&(200==s.status?o():t())},s.send(e)})}(u).then(()=>c.innerHTML=e.loading).then(()=>{t==r?(d.style.display="none",n.style.display="none"):t==o?(d.style.display="none",n.style.display="none",y.style.display="none"):t==h&&(n.style.display="none",d.style.display="none",b.classList.add("hidden-lg"),b.classList.add("hidden-sm"),b.classList.add("hidden-xs"),i.classList.remove("hidden-lg"),i.classList.remove("hidden-md"),i.classList.remove("hidden-sm"),i.classList.remove("hidden-xs")),c.style.textAlign="center",c.innerHTML=e.success}).catch(()=>c.innerHTML=e.failure)})}function M(e){e.addEventListener("keypress",function(){let e=this;setTimeout(function(){e.value=e.value.replace(/[a-zA-z]|[а-яА-Я]/g,""),e.value=e.value.replace(/[0-9][+]/g,e.value.substr(e.value.length),""),e.value=e.value.replace(/[+][+]/g,e.value.substr(e.value.length),"")},0)})}function I(e){e.addEventListener("keypress",function(){let e=this;setTimeout(function(){e.value=e.value.replace(/[^а-яА-ЯЁё ]/g,"")},0)})}function z(e){e.value=""}function W(e,t,s,n){t.removeChild(c),e==r?(n.style.display="block",s.style.display="block"):e==o?(n.style.display="block",s.style.display="block",y.style.display="block"):e==h&&(s.style.display="block",n.style.display="block",b.classList.remove("hidden-lg"),b.classList.remove("hidden-sm"),b.classList.remove("hidden-xs"))}i.classList.add("button"),i.classList.add("button-order"),i.classList.add("hidden-lg"),i.classList.add("hidden-md"),i.classList.add("hidden-sm"),i.classList.add("hidden-xs"),i.textContent="Ещё вопросы?",M(s),M(l),M(S),I(t),I(d),I(u),I(g),I(w),C(r,a,m,p),C(o,j,f,_),C(h,v,O,q),T.addEventListener("click",()=>{W(o,j,f,_),z(n),z(t),z(s),z(u)}),P.addEventListener("click",()=>{event.target.closest(".popup-content")||(P.style.display="none",document.body.style.overflow="",W(o,j,f,_),z(n),z(t),z(s),z(u))}),A.addEventListener("click",()=>{W(r,a,m,p),z(g),z(S)}),$.addEventListener("click",()=>{event.target.closest(".popup-content")||($.style.display="none",document.body.style.overflow="",W(r,a,m,p),z(g),z(S))}),i.addEventListener("click",()=>{W(h,v,O,q),z(L),z(x),z(k),z(E),v.removeChild(i)})}},"./src/js/parts/gift-modal.js":
/*!************************************!*\
