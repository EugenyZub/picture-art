...
/*!*****************************************************!*\
  ...
  \*****************************************************/
/*! no static exports found */function(e,o,s){"use strict";var t=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),n=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),r=s(/*! ./_fails */"./node_modules/core-js/modules/_fails.js"),d=s(/*! ./_defined */"./node_modules/core-js/modules/_defined.js"),l=s(/*! ./_wks */"./node_modules/core-js/modules/_wks.js");e.exports=function(e,o,s){var u=l(e),c=s(d,u,""[e]),i=c[0],m=c[1];r(function(){var o={};return o[u]=function(){return 7},7!=""[e](o)})&&(n(String.prototype,e,i),t(RegExp.prototype,u,2==o?function(e,o){return m.call(e,this,o)}:function(e){return m.call(e,this)}))}},"./node_modules/core-js/modules/_global.js":
/*!*************************************************!*\
...
/*!************************************************************!*\
  ...
  \************************************************************/
/*! no static exports found */function(e,o,s){s(/*! ./_fix-re-wks */"./node_modules/core-js/modules/_fix-re-wks.js")("replace",2,function(e,o,s){return[function(t,n){"use strict";var r=e(this),d=void 0==t?void 0:t[o];return void 0!==d?d.call(t,r,n):s.call(String(r),t,n)},s]})},"./node_modules/core-js/modules/web.dom.iterable.js":
/*!**********************************************************!*\
...
/*!************************!*\
  !*** ./src/js/main.js ***!
  \************************/
/*! no exports provided */function(e,o,s){"use strict";s.r(o);var t=s(/*! ./parts/slider */"./src/js/parts/slider.js"),n=s(/*! ./parts/modal-popup-design */"./src/js/parts/modal-popup-design.js"),r=s(/*! ./parts/modal-popup-consultation */"./src/js/parts/modal-popup-consultation.js"),d=s(/*! ./parts/styles */"./src/js/parts/styles.js"),l=s(/*! ./parts/big-slider */"./src/js/parts/big-slider.js"),u=s(/*! ./parts/often-questions */"./src/js/parts/often-questions.js"),c=s(/*! ./parts/calc */"./src/js/parts/calc.js"),i=s(/*! ./parts/filter */"./src/js/parts/filter.js"),m=s(/*! ./parts/gift-modal */"./src/js/parts/gift-modal.js"),a=s(/*! ./parts/menu */"./src/js/parts/menu.js"),j=s(/*! ./parts/pictures-with-different-size */"./src/js/parts/pictures-with-different-size.js"),f=s(/*! ./parts/form */"./src/js/parts/form.js");window.addEventListener("DOMContentLoaded",function(){Object(l.default)(),Object(c.default)(),Object(i.default)(),Object(m.default)(),Object(a.default)(),Object(f.default)(),Object(n.default)(),Object(r.default)(),Object(d.default)(),Object(u.default)(),Object(j.default)(),Object(t.default)()})},"./src/js/parts/big-slider.js":
/*!************************************!*\
  !*** ./src/js/parts/big-slider.js ***!
  \************************************/
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){let e=document.querySelectorAll(".portfolio-menu li"),o=document.querySelector(".portfolio-menu .all"),s=document.querySelector(".portfolio-menu .lovers"),t=document.querySelector(".portfolio-menu .chef"),n=document.querySelector(".portfolio-menu .girl"),r=document.querySelector(".portfolio-menu .guy"),d=document.querySelector(".portfolio-menu .grandmother"),l=document.querySelector(".portfolio-menu .granddad"),u=document.querySelectorAll(".portfolio-wrapper .all"),c=document.querySelectorAll(".portfolio-wrapper .lovers"),i=document.querySelectorAll(".portfolio-wrapper .chef"),m=document.querySelectorAll(".portfolio-wrapper .girl"),a=document.querySelectorAll(".portfolio-wrapper .guy"),j=document.querySelector(".container .portfolio-no");function f(){u.forEach(e=>{e.style.display="none"}),j.style.display="none",e.forEach(e=>{e.classList.remove("active")})}function p(e,o){e.addEventListener("click",()=>{f(),o.forEach(o=>{e.classList.add("active"),o.style.display="block"})})}function _(e,o){e.addEventListener("click",()=>{f(),e.classList.add("active"),o.style.display="block"})}p(o,u),p(s,c),p(t,i),p(n,m),p(r,a),_(d,j),_(l,j)}},"./src/js/parts/form.js":
/*!******************************!*\
  !*** ./src/js/parts/form.js ***!
  \******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/es6.regexp.replace */"./node_modules/core-js/modules/es6.regexp.replace.js");o.default=function(){let e={loading:"Загрузка...",success:"Спасибо! Скоро мы с вами свяжемся!",failure:"Что-то пошло не так"},o=document.querySelector(".popup-design form"),s=(o.querySelector("#design-name"),o.querySelector("#design-phone")),t=(o.querySelector("#design-email"),document.querySelector(".popup-consultation form")),n=(t.querySelector("#consultation-name"),t.querySelector("#consultation-phone")),r=document.createElement("div");function d(e){e.addEventListener("keypress",function(){let e=this;setTimeout(function(){e.value=e.value.replace(/[a-zA-z]|[а-яА-Я]/g,""),e.value=e.value.replace(/[0-9][+]/g,e.value.substr(e.value.length),""),e.value=e.value.replace(/[+][+]/g,e.value.substr(e.value.length),"")},0)})}d(s),d(n),function(o){o.addEventListener("submit",function(s){s.preventDefault(),o.appendChild(r),function(e){return new Promise(function(o,s){let t=new XMLHttpRequest;t.open("POST","server.php"),t.setRequestHeader("Content-type","application/json; charset=utf-8"),t.onreadystatechange=function(){t.readyState<4?o():4===t.readyState&&(200==t.status?o():s())},t.send(e)})}(new FormData(o)).then(()=>r.innerHTML=e.loading).then(()=>{r.innerHTML=e.success}).catch(()=>r.innerHTML=e.failure)})}(t)}},"./src/js/parts/gift-modal.js":
/*!************************************!*\
