...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var t=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),r=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),n=s(/*! ./_hide */"./node_modules/core-js/modules/_hide.js"),u=s(/*! ./_redefine */"./node_modules/core-js/modules/_redefine.js"),d=s(/*! ./_ctx */"./node_modules/core-js/modules/_ctx.js"),l=function(e,o,s){var c,i,m,a,j=e&l.F,f=e&l.G,_=e&l.S,p=e&l.P,y=e&l.B,b=f?t:_?t[o]||(t[o]={}):(t[o]||{}).prototype,v=f?r:r[o]||(r[o]={}),h=v.prototype||(v.prototype={});for(c in f&&(s=o),s)m=((i=!j&&b&&void 0!==b[c])?b:s)[c],a=y&&i?d(m,t):p&&"function"==typeof m?d(Function.call,m):m,b&&u(b,c,m,e&l.U),v[c]!=m&&n(v,c,a),p&&h[c]!=m&&(h[c]=m)};t.core=r,l.F=1,l.G=2,l.S=4,l.P=8,l.B=16,l.W=32,l.U=64,l.R=128,e.exports=l},"./node_modules/core-js/modules/_fails.js":
/*!************************************************!*\
...
/*!******************************************************!*\
  ...
  \******************************************************/
/*! no static exports found */function(e,o,s){var t=s(/*! ./_object-keys-internal */"./node_modules/core-js/modules/_object-keys-internal.js"),r=s(/*! ./_enum-bug-keys */"./node_modules/core-js/modules/_enum-bug-keys.js");e.exports=Object.keys||function(e){return t(e,r)}},"./node_modules/core-js/modules/_property-desc.js":
/*!********************************************************!*\
...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */function(e,o,s){var t=s(/*! ./_core */"./node_modules/core-js/modules/_core.js"),r=s(/*! ./_global */"./node_modules/core-js/modules/_global.js"),n=r["__core-js_shared__"]||(r["__core-js_shared__"]={});(e.exports=function(e,o){return n[e]||(n[e]=void 0!==o?o:{})})("versions",[]).push({version:t.version,mode:s(/*! ./_library */"./node_modules/core-js/modules/_library.js")?"pure":"global",copyright:"© 2018 Denis Pushkarev (zloirock.ru)"})},"./node_modules/core-js/modules/_to-absolute-index.js":
/*!************************************************************!*\
...
/*!********************************!*\
  ...
  \********************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){let e=document.querySelectorAll(".portfolio-menu li"),o=document.querySelector(".portfolio-menu .all"),s=document.querySelector(".portfolio-menu .lovers"),t=document.querySelector(".portfolio-menu .chef"),r=document.querySelector(".portfolio-menu .girl"),n=document.querySelector(".portfolio-menu .guy"),u=document.querySelector(".portfolio-menu .grandmother"),d=document.querySelector(".portfolio-menu .granddad"),l=document.querySelectorAll(".portfolio-wrapper .all"),c=document.querySelectorAll(".portfolio-wrapper .lovers"),i=document.querySelectorAll(".portfolio-wrapper .chef"),m=document.querySelectorAll(".portfolio-wrapper .girl"),a=document.querySelectorAll(".portfolio-wrapper .guy"),j=document.querySelector(".container .portfolio-no");function f(){l.forEach(e=>{e.style.display="none"}),j.style.display="none",e.forEach(e=>{e.classList.remove("active")})}function _(e,o){e.addEventListener("click",()=>{f(),o.forEach(o=>{e.classList.add("active"),o.style.display="block"})})}function p(e,o){e.addEventListener("click",()=>{f(),e.classList.add("active"),o.style.display="block"})}_(o,l),_(s,c),_(t,i),_(r,m),_(n,a),p(u,j),p(d,j)}},"./src/js/parts/gift-modal.js":
/*!************************************!*\
  !*** ./src/js/parts/gift-modal.js ***!
  \************************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o),o.default=function(){let e=document.querySelector(".fixed-gift"),o=document.querySelector(".popup-gift"),s=o.querySelector(".popup-close");e.addEventListener("click",()=>{o.style.display="block",document.body.style.overflow="hidden",e.parentNode.removeChild(e)}),o.addEventListener("click",()=>{event.target.closest(".popup-content")||(o.style.display="none",document.body.style.overflow="")}),s.addEventListener("click",()=>{o.style.display="none",document.body.style.overflow=""})}},"./src/js/parts/modal-popup-consultation.js":
/*!**************************************************!*\
  !*** ./src/js/parts/modal-popup-consultation.js ***!
  \**************************************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){let e=document.querySelectorAll(".button-consultation"),o=document.querySelector(".popup-consultation"),s=o.querySelector(".popup-close"),t=document.querySelector(".popup-gift"),r=document.querySelector(".popup-design");e.forEach(function(e){e.addEventListener("click",()=>{o.style.display="block",document.body.style.overflow="hidden"})}),o.addEventListener("click",()=>{event.target.closest(".popup-content")||(o.style.display="none",document.body.style.overflow="")}),s.addEventListener("click",()=>{o.style.display="none",document.body.style.overflow=""});let n=setTimeout(function e(){o.style.display="block",document.body.style.overflow="hidden","block"!=t.style.display&&"block"!=r.style.display||(o.style.display="none",clearTimeout(n)),setTimeout(e,6e4)},6e4)}},"./src/js/parts/modal-popup-design.js":
/*!********************************************!*\
...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){let e=document.querySelectorAll(".accordion-block"),o=document.querySelectorAll(".accordion-heading"),s=document.querySelectorAll("#accordion div");e.forEach(e=>{e.classList.add("hidden-lg")}),o.forEach((t,r)=>{let n=t.querySelector("span");t.addEventListener("click",()=>{s[r].classList.toggle("hidden-lg"),s[r].style.marginBottom="20px",s[r].style.marginTop="20px";let t=r;(n=o[t].querySelector("span")).classList.toggle("active"),e.forEach((e,s)=>{s!=t&&(e.classList.add("hidden-lg"),(n=o[s].querySelector("span")).classList.remove("active"))})})})}},"./src/js/parts/slider.js":
/*!********************************!*\
