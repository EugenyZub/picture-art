...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: default */function(e,o,t){"use strict";t.r(o);t(/*! core-js/modules/es6.regexp.replace */"./node_modules/core-js/modules/es6.regexp.replace.js");o.default=function(){let e={loading:"Загрузка...",success:"Спасибо! Скоро мы с вами свяжемся!",failure:"Что-то пошло не так"},o=document.querySelector(".popup-design form"),t=o.querySelector("#design-name"),s=o.querySelector("#design-phone"),n=document.querySelector(".popup-consultation form"),r=n.querySelector("#consultation-name"),d=n.querySelector("#consultation-phone"),u=document.querySelector("#textarea"),l=document.createElement("div"),c=document.querySelector(".popup-consultation .popup-content"),i=document.querySelector(".popup-consultation h4"),a=document.querySelector(".popup-consultation .main-form"),m=document.querySelector(".popup-design .popup-content"),j=document.querySelector(".popup-design h4"),p=document.querySelector(".popup-design .file_uploa"),f=document.querySelector(".popup-design .main-form");function _(o,t,s,r){o.addEventListener("submit",function(d){d.preventDefault(),t.appendChild(l),function(e){return new Promise(function(o,t){let s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-type","application/json; charset=utf-8"),s.onreadystatechange=function(){s.readyState<4?o():4===s.readyState&&(200==s.status?o():t())},s.send(e)})}(new FormData(o)).then(()=>l.innerHTML=e.loading).then(()=>{o==n?(r.style.display="none",s.style.display="none"):(r.style.display="none",s.style.display="none",p.style.display="none"),l.innerHTML=e.success}).catch(()=>l.innerHTML=e.failure)})}function y(e){e.addEventListener("keypress",function(){let e=this;setTimeout(function(){e.value=e.value.replace(/[a-zA-z]|[а-яА-Я]/g,""),e.value=e.value.replace(/[0-9][+]/g,e.value.substr(e.value.length),""),e.value=e.value.replace(/[+][+]/g,e.value.substr(e.value.length),"")},0)})}function v(e){e.addEventListener("keypress",function(){let e=this;setTimeout(function(){e.value=e.value.replace(/[^а-яА-ЯЁё ]/g,"")},0)})}y(s),y(d),v(t),v(r),v(u),_(n,c,i,a),_(o,m,j,f)}},"./src/js/parts/gift-modal.js":
/*!************************************!*\
